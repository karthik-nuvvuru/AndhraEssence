...
class TestCreateRazorpayOrder:
    ...
    async def test_create_razorpay_order_success(self, client, customer_token, seeded_db):
        ...
        response = await client.post("/api/v1/payments/create-order", json={
            "order_id": order["id"],
    ...
    async def test_create_razorpay_order_wrong_customer(self, client, customer_token, owner_token, seeded_db):
...
class TestVerifyPayment:
    ...
    async def test_verify_payment_invalid_signature(self, client, customer_token, seeded_db):
